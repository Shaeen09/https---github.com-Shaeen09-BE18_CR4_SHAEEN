...
<body>
    <form method="POST">
        ...
        <input type="text" placeholder="Please enter the description" name="name" value="<?= $row["description"] ?>">
        <input type="text" placeholder="Please enter the type" name="name" value="<?= $row["type"] ?>">
        <input type="text" placeholder="Please enter the Author_first_Name" name="name" value="<?= $row["fname"] ?>">
        <input type="text" placeholder="Please enter the Author_last_Name" name="name" value="<?= $row["lname"] ?>">
        <input type="text" placeholder="Please enter the Publisher_Name" name="name" value="<?= $row["pname"] ?>">
        <input type="text" placeholder="Please enter the Publisher_Address" name="name" value="<?= $row["padd"] ?>">
